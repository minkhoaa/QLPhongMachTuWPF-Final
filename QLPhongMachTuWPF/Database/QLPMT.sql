...
CREATE TABLE LICHHEN (
    ...
    TrangThai INT,
    NgayKham SMALLDATETIME,
    CONSTRAINT LH_MaLH_PK PRIMARY KEY (MaLH),
    CONSTRAINT LH_MaNV_FK FOREIGN KEY (MaNV) REFERENCES NHANVIEN(MaNV),
    CONSTRAINT LH_MaBN_FK FOREIGN KEY (MaBN) REFERENCES BENHNHAN(MaBN)
);
